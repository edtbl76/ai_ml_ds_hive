...
class ChatBot:
    negative_commands = ("no", "nope", "nah", "naw", "not a chance", "sorry", "fuck off")

    exit_commands = ("quit", "pause", "exit", "go away", "piss off", "goodbye", "bye", "later", "stop")

    def start_chat(self):
        user_response = input("Hi! I'm FuckBot. Would you like to chat with me?\n")
